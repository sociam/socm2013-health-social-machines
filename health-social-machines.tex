...
other mechanisms (such as the gameification components described
...
A second challenge concerns the effectiveness of the current methods
health social machines use towards sustaining truly difficult
intevenions that challenge the very centres of people's motivational
systems, such as those concerning weight loss and depression.

In particular, a number of recent studies on gameification have
...
novelty \cite{wearoff}.  Meanwhile, other studies of gameification
showed that gameification elements actually decreased participation by
...
Behavioural economics experts Susstein and Thaler 

\subsection{Self-Bias and Explaining-Away}
% \section{Approaches}
