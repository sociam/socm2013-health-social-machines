...
\item \emph{Gameification (Prizes)} - To futher motivate compliance,
  many of these systems incorporated a number of ``gameification''
  features \cite{gameification} meant to make progres seem like play.
  Such features typically involved rewarding participants with
  ``points'', ``badges'' and ``prizes'' for achieving milestones.
