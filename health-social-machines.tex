...
The first which we refer to as \emph{behavioural intervention social
...
individuals increase their general activity levels to increase
fitness.  Since these systems generally do not target any particular
demographics or those with particular conditions,  we consider them
...
exemplar (i.e., PatientsLikeMe), consists of systems that crowd-source
the understanding of disease, symptoms and treatments to individuals
who have personally experienced them.  PatientsLikeMe facilitates the
independent report of symptoms that individuals are experiencing, the
disease/condition they have been diganosed with, and the effects of
particular treatments on their conditions.  The result of this
aggregation, at large scale, is a model relating symptoms to diseases
to 

\section{How do Social Machines Support People's Health Today}
