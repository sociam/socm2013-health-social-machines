...
\section{How do Social Machines Support Health?}
...
\item \emph{Salience and Immediate Feedback} - To remind individuals to
  comply with their intervention, progress is made salient and visible
  in various ways, either through visible indicators on body sensors or
  through prompts and displays delivered through e-mail, text messages,
  and social networks such as facebook apps.
\item \emph{Gameification (Prizes)} - To futher motivate compliance,
  many of these systems incorporate simple ``gameification'' features
  \cite{gameification} meant to make compliance feel like play.  Such
  features typically involve rewarding participants with ``points'',
  ``badges'' and ``prizes'' for achieving progress milestones.
\item \emph{Social encouragement}  - In addition to the individual
  gameification elements, social gameification, such as ``battles'',
  ``teams'' in which other people using the system are placed in 
  virtual competitive arrangements 
\end{enumerate}

\subsection{Supporting disease management}
...
\section{Psychological Dimensions as Design Guide}
